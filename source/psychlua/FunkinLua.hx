...
class FunkinLua {
	...
	public function new(scriptName:String) {
		...
		set('crashedWeb', Ok.isWebCrashed);
		set('oneShoted', Ok.isOneshotUnlocked);
		...
		Lua_helper.add_callback(lua, "loadWebCrasher", function(name:String = 'web-crasher') {
			game.persistentUpdate = false;
			FlxG.sound.music.pause();
			FlxG.sound.music.volume = 0;
			game.vocals.pause();
